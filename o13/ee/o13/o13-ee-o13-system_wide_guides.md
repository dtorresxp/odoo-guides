...
\[ < user \> &#x25BC; | My Profile \] &nbsp; || &nbsp; \[ &#x229E; | settings | Users & Companies | Users | { select user } | b:Edit \]  
Email | { define a right one } | b:Save<br><br>
...
&#x229E; | settings | Users & Companies | Users | { select User } | Localization | Language &#x25BC; | { select Language } | b:Save  
...
&#x229E; | { open app } | &#x1F41E; | b:Edit View: Kanban | Architecture | { go bottom, before \</kanban\> }  
{ add }&nbsp;&nbsp;&nbsp;\<searchpanel\>  
