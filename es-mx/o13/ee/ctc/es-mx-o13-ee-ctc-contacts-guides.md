...
![apps](/doc/img/apps.png) | o:Contacts | _a:Seleccionar map view_ ![view_map](/doc/img/view_map.png) | _a:Use b:+_ || _b:- to zoom map_  
_a:Hover on every ![map_location](/doc/img/map_location.png) on map to see contact's data_ | _a:Use b:Editar to modify contact as usual_  
_a:Use b:VerInGoogleMaps to see it outside Odoo_  
